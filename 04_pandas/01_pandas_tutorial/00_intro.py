"""
1. Pandas adalah perpustakaan Python yang digunakan untuk bekerja dengan kumpulan data.
2. Nama "Pandas" mengacu pada "Panel Data" dan "Analisis Data Python" dan dibuat oleh Wes McKinney pada tahun 2008.
3. Fungsi pandas:
    - menganalisis => memungkinkan kita menganalisis data besar dan membuat kesimpulan berdasarkan teori statistik.
    - membersihkan
        a. dapat membersihkan kumpulan data yang berantakan, dan membuatnya mudah dibaca dan relevan.
        b. menghapus baris yang tidak relevan, atau berisi nilai yang salah, seperti nilai kosong atau NULL.
    - mengeksplorasi
    - memanipulasi data

Ilmu Data: adalah cabang ilmu komputer tempat kita mempelajari cara menyimpan, menggunakan, dan menganalisis data untuk memperoleh informasi darinya.
alias: Dalam Python alias adalah nama alternatif untuk merujuk pada hal yang sama.

1. Install pandas => pip install pandas
2. Pandas biasanya diimpor dengan pd nama alias.
3. String versi disimpan di bawah pd.__version__ atribut.

Semua properti dan metode objek DataFrame, beserta penjelasan dan contohnya:
...
"""
## Muat file CSV ke dalam Pandas DataFrame
# import pandas as pd
#
